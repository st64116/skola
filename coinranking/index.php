...
<body>
<section class="bg-cover container-fluid">
    ...
    <div class="container-md text-light my-4">
        ...
        <div class="row py-5">
            <div class="col-12 col-md-6 text-center ms-auto">
                <h1 class="display-1 fw-bold text-left">watch <span id="numberOfCoins">14500</span> cryptocurencies on 1
                    site</h1>
                <a href="coins.php?page=0">
                    <button class="btn btn-lg btn-outline-light my-5"><span class="p-5">Coins</span></button>
                </a>
            </div>
